...
- [npm实用包](#npm实用包)
  ...
  - [Vue](#vue)
    ...
    - [复制粘贴板](#复制粘贴板)
      - [vue-clipboard2：vue-clipboard2](#vue-clipboard2vue-clipboard2)
      - [vue-copy-to-clipboard：vue-copy-to-clipboard](#vue-copy-to-clipboardvue-copy-to-clipboard)
    - [代码在线编辑：vue-codemirror](#代码在线编辑vue-codemirror)
    - [vue 拖拽：vuedraggable](#vue-拖拽vuedraggable)
  - [Helper](#helper)
    - [基于rsa加解密的js库](#基于rsa加解密的js库)
  ...
  - [工具](#工具)
    ...
    - [diagram-js：在web应用程序上显示和修改图表的工具集合](#diagram-js在web应用程序上显示和修改图表的工具集合)
    - [web流程图：bpmn.js](#web流程图bpmnjs)
    - [保存较大的文件：stream-saver](#保存较大的文件stream-saver)
    - [保存文件：file-saver](#保存文件file-saver)
    - [vditor: markdown在线编辑器，支持vue和react](#vditor-markdown在线编辑器支持vue和react)
...
> [文档](https://goldsubmarine.github.io/xcrud/)

### [图片裁剪](https://github.com/xyxiao001/vue-cropper)：vue-cropper

### 复制粘贴板

#### [vue-clipboard2](https://github.com/Inndy/vue-clipboard2)：vue-clipboard2

#### [vue-copy-to-clipboard](https://github.com/vueComponent/vue-copy-to-clipboard)：vue-copy-to-clipboard
...
### [基于rsa加解密的js库](https://github.com/travist/jsencrypt)

>资料一：<https://segmentfault.com/a/1190000023404169>
>
...
还可以格式化SQL、CSS，还可以做压缩。

> [在vue中使用vkbeautify将xml、json格式化展示](https://juejin.cn/post/7148735373047234591)

### [富文本编辑器](https://github.com/quilljs/quill)

> [中午文档](https://kang-bing-kui.gitbook.io/quill)  
> [官网](https://quilljs.com/)  

### [轻量级的搜索引擎](https://github.com/krisk/Fuse)：fuse.js

> [官网](https://fusejs.io/)
> [VUE开发--fuse.js模糊搜索](https://www.jianshu.com/p/44e8edb4c404)  

### [diagram-js](https://github.com/bpmn-io/diagram-js/blob/develop/karma.conf.js)：在web应用程序上显示和修改图表的工具集合

Bpmn.js 内部依赖 diagram.js 和 bpmn-moddle

### [web流程图](https://github.com/bpmn-io/bpmn-js)：bpmn.js
...
### [保存较大的文件](https://github.com/jimmywarting/StreamSaver.js)：stream-saver

### [保存文件](https://github.com/eligrey/FileSaver.js)：file-saver

> 资料一：<https://www.cnblogs.com/yunser/p/7629399.html>

### [vditor](https://b3log.org/vditor/demo/): markdown在线编辑器，支持vue和react
...
### [拖拽工具](https://github.com/SortableJS/Sortable)：Sortablejs
...
### [node交互式命令行提示器](https://github.com/SBoudrias/Inquirer.js)：Inquirer

>[Inquirer 交互式命令行提示器](https://juejin.cn/post/6981736393458319397)
>
